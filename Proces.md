# Uge 38+39
## Hvad har jeg lavet?
Vi har taget vores wireframes og er nu i gang med at omdanne dem til frontend-delen. Jeg følger en React-tutorial og arbejder med grundlæggende JavaScript for at bygge grænsefladen og funktionaliteten ud fra vores skitser.
...
•	Validering: Kontrollerer, om data opfylder bestemte krav (f.eks. længde, format, type, værdiområde) og afviser ugyldige data.
•	Sanitering: Renser data for potentielt farlige eller uønskede tegn for at forhindre sikkerhedsproblemer (f.eks. XSS, SQL injection).
•	
